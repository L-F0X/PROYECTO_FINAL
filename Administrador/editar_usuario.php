                ...
                <form action="editar_usuario.php?id=<?= $idUsuario ?>" method="POST">
                    ...
                    <div class="profile-grid">
                        ...
                        <div class="profile-field">
                            ...
                            <input type="text" id="nombre" name="nombre" value="<?= htmlspecialchars($user['NOMBRE']) ?>" required maxlength="100" autocomplete="off" title="Ingresa el o los nombres">
                        </div>

                        <div class="profile-field">
                            <label for="apellido">Apellidos</label>
                            <input type="text" id="apellido" name="apellido" value="<?= htmlspecialchars($user['APELLIDO']) ?>" required maxlength="100" autocomplete="off" title="Ingresa el o los apellidos">
                        </div>
