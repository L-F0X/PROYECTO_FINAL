...
<header class="header-main">
    <div class="header-left" style="display: flex; align-items: center; gap: 15px;">
        ...
        <div>
            <h1 class="header-title">BICERGAM | <span class="accent-color">Certificados</span></h1>
...
<div class="dashboard-page">
    <aside class="dashboard-sidebar">
        ...
        <div class="sidebar-group">
            ...
            <a href="historial_existencia.php" class="sidebar-link sidebar-link--primary">Certificados Existencia</a>
        </div>
